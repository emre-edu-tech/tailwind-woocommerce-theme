...
<body <?php body_class(); ?>>
	<div class="bg-white shadow py-1">
		<!-- Nav -->
		<nav class="navbar-container max-w-6xl mx-auto relative">
			<div class="px-4 sm:px-6 lg:px-0">
				<div class="flex h-16 justify-between">
					<div class="flex">
						<div class="flex flex-shrink-0 items-center">
							<a href="<?php echo get_home_url(); ?>">
								<img class="h-8 w-auto" src="<?php echo get_theme_file_uri('/img/ecommerce-logo.png') ?>" alt="<?php bloginfo('site-title') ?>">
							</a>
						</div>
					...
					<div class="flex items-center sm:hidden">
						<!-- Mobile menu button -->
						<button id="btn-mobile" type="button" class="inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" aria-controls="mobile-menu" aria-expanded="false">
							...
							-->
							<svg class="open-menu h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
							...
							-->
							<svg class="close-menu hidden h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
			...
			<div class="hidden absolute top-[h-80px] w-full bg-white shadow" id="mobile-menu">
